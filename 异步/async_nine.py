...
print(done)  # {<Task finished coro=<work_2() done, defined at D:/PycharmProjects/TestCode/异步/async_nine.py:14> result='Work 2 is finished'>, <Task finished coro=<work_1() done, defined at D:/PycharmProjects/TestCode/异步/async_nine.py:5> result='Work 1 is finished'>}
print(pending)  # set()
for task in done:
    print(task)  # <Task finished coro=<work_2() done, defined at D:/PycharmProjects/TestCode/异步/async_nine.py:14> result='Work 2 is finished'>
    print(task.result())  # Work 2 is finished
